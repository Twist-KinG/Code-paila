          ...
          <div className="max-w-xl mx-auto relative bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-2xl border border-white/50">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea rows={6} className="w-full px-6 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 resize-none bg-white/50 backdrop-blur-sm"
                  placeholder="Describe your project, goals, and how we can help bring your vision to life..."
                ></textarea>
              </div>

              <button type="submit" className="group w-full bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 text-white px-8 py-5 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 flex items-center justify-center space-x-3 transform hover:-translate-y-1 hover:scale-105">
