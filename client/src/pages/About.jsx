      ...
      <div className="max-w-screen mx-auto relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We're not just building software – we're crafting digital experiences
            that bridge the mystical beauty of Nepal with the infinite
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16 lg:mb-20">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <p className="text-gray-600 leading-relaxed text-base sm:text-lg">
              ...
              breakthrough in technology might just come from the rooftop of the
              world.
            </p>

            {/* Vision Card */}
            <div className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-teal-50 p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-blue-100">
              <div className="absolute top-4 right-4">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
              </div>
              <h4 className="font-bold text-gray-900 mb-2 sm:mb-3 text-lg sm:text-xl">
                Our Vision
              </h4>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                To establish Nepal as a global epicenter of technological
                innovation, while creating meaningful digital solutions that make
                the world a little more connected, a little more beautiful, and a
                lot more inspired.
              </p>
            </div>
          </div>
